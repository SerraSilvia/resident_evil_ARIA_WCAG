  ...
  render() {
    ...
    return (
      <div
        ...
        role="button" // ARIA: cada videojuego es un botón
        tabIndex={0}    // WCAG: permite enfocar la tarjeta con teclado
        aria-label={`Videojuego: ${title}, año ${year}`} // ARIA: descripción de la tarjeta
      >
        {/* Año */}
        ...
        <div
          ...
          aria-label={`Portada y título del videojuego ${title}`}
        >
          <img
            alt={`Portada del videojuego ${title}`} // ARIA implícito
        ...
        <div
          ...
          aria-label={`Sinopsis del videojuego ${title}`} // ARIA: describe la sinopsis
